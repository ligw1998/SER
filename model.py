...
class Acrnn(pl.LightningModule):
    def __init__(self, num_classes=4, is_training=True,
                 ...
                 p=10, time_step=150, F1=64, dropout_keep_prob=1, learning_rate=1e-5):
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.Adam(self.parameters(), lr=self.learning_rate, betas=(0.9, 0.999), weight_decay=5e-4)
